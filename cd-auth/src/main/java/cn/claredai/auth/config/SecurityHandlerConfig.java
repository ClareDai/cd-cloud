...
import cn.claredai.auth.handler.OauthLogoutHandler;
 ...
 * @Description 认证错误处理
 * @Author ClareDai
 * @Date create in 2019/6/24 11:56
 **/
@Slf4j
@Configuration
public class SecurityHandlerConfig {
    ...
    public AuthenticationFailureHandler loginFailureHandler() {
        return (request, response, exception) -> {
            ...
            ResponseUtil.responseWriter(response, msg, HttpStatus.UNAUTHORIZED.value());
        };
    }
